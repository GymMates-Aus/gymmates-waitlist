    ...
    <section id="trust" className="bg-bone py-14 sm:py-20">
      <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
        ...
        <p className="text-[18px] sm:text-[20px] leading-[1.55] text-ink">
          Built by gym owners who run a gym, for gym owners. The team behind Next
          Level Echuca has spent 13+ years working out what makes members
          actually show up. Spoiler: <span className="accent-italic">it&rsquo;s mates.</span>
        </p>
